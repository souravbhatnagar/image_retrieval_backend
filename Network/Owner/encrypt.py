...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 26 17:34:55 2020
...
class Encrypt():
    ...
    def encrypt_image(self, img_dir, image, key):
        self.dir = img_dir
        self.HenonEncryption(self.dir+image, key)
    ...
    def HenonEncryption(self, imageName,key):
